...
void openDonate(BuildContext c, {Project? project}) => _push(c, DonateScreen(project: project));
...
void openMyContributions(BuildContext c) => _push(c, const MyContributionsScreen());
